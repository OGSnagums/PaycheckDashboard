...
export const DEFAULTS = {
  ...
  accentColor: "#c9a84c",
  bills: [
    { id: "rent", label: "Rent / Water", amount: 764.0, category: "housing", account: "fidelity", icon: "🏠", active: true, rollsTo: null },
  ...
  ccDebitAcct: 1006.0,
  ccStatements: { acc: 3041.14, fcc: 1820.39, ccc: 989.06 },
...
export const BONUS_PRESET = {
  ...
  ccOverrides: { acc: 947, fcc: 76, ccc: 0 }
};
...
export function migrateState(s) {
  ...
  if (Array.isArray(s.creditCards)) {
    const nameMap = { acc: "Apple Card", fcc: "Fidelity Visa Signature", ccc: "Chase Credit Card" };
    s.creditCards = s.creditCards.map((c) => ({ ...c, label: nameMap[c.id] || c.label }));
  }
